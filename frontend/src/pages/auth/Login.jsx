// Integration Done on 17-12-2025 18:56
...
const SignIn = () => {
  ...
  const handleGoogleSuccess = async (user) => {
    ...
    try {
      ...
      console.log('[Login] Registering presence:', payload);
      ...
      if (!response.ok) {
        ...
        console.log('[Login] Presence registered successfully:', result);
      }
    } catch (err) {
        ...
        >
          <div className="text-white">
            ...
            <div className="space-y-4">
                <GoogleSignInPopup
                  redirect={`${BACKEND_API}/api/auth/google`}
