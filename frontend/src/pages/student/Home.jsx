    ...
    return (
      <section className="py-8 lg:py-12">
        ...
        <motion.div
          ...
          className="relative overflow-hidden rounded-2xl bg-gray-200 p-12 shadow-xl shadow-brand-300/60 border-2 border-sky-500"
        >
          {/* Animated background elements */}
          <div className="absolute inset-0 bg-gradient-to-tr from-brand-50/30 to-transparent" />
          <motion.div
            className="absolute top-0 right-0 w-96 h-96 bg-brand-100/20 rounded-full blur-3xl"
            animate={{ y: [0, 20, 0], x: [0, 10, 0] }}
            transition={{ duration: 8, repeat: Infinity }}
          />
          <motion.div
            className="absolute bottom-0 left-0 w-72 h-72 bg-brand-100/20 rounded-full blur-3xl"
            animate={{ y: [0, -20, 0], x: [0, -10, 0] }}
          ...
          <div className="relative z-10 text-center">
            ...
            <motion.div
              ...
              className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-brand-600 shadow-2xl mb-6"
            >
            ...
            <div className="mt-8 grid grid-cols-3 gap-4 max-w-md mx-auto">
              <div className="flex flex-col items-center">
                ...
                <span className="text-xs font-medium text-gray-700">Progress Tracking</span>
              </div>
              <div className="flex flex-col items-center">
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="text-xs font-medium text-gray-700">AI Tips</span>
              </div>
            </div>
          </div>
        </motion.div>
      ...
      <AnimatePresence mode="wait">
        {displayedDomains.length > 0 || !searchQuery ? (
          <>
            ...
            {/* View All Button - Only shown when not expanded */}
            {hasMoreDomains && !showAll && (
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                >
                  <span className="text-lg">
                    View All Domains ({filteredDomains.length - (exploreAllStartIndex + 4)} more)
                  </span>
                  <motion.div>
            ...
            {showAll && filteredDomains.length > (exploreAllStartIndex + 4) && (
              ...
              >
                ...
                {/* View Less Button - Shown at bottom when expanded */}
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: 0.3 }}
